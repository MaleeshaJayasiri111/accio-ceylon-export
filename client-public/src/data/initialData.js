...
export const INITIAL_REVIEWS = [
  {
    ...
    author_company: 'London Organic Snacks Ltd',
    ...
    status: 'approved',
    is_featured: 1,
    photo_urls: ['/reviews/review_gleora_table.png'],
  ...
  },
  {
    ...
    product_id: 'prod_mango_01',
    product_name: 'Ceylon Solar Dehydrated Mango Slices',
    author_name: 'Klaus Reinhardt',
    author_company: 'Bavaria Bio-Handel GmbH',
    ...
    status: 'approved',
    is_featured: 1,
    photo_urls: ['/reviews/review_gleora_hand.jpg'],
  ...
  },
  {
    ...
    author_company: 'Sydney Fine Foods',
    ...
    status: 'approved',
    is_featured: 1,
    photo_urls: ['/products/banana_slices.jpg'],
